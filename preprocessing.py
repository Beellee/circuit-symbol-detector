...
noise_cleanup_min_area = 6 # remove tiny blobs smaller than this area (tuned to remove speckle noise without affecting real strokes)
...
def preprocess(image_path: str, debug: bool = False) -> tuple[np.ndarray, np.ndarray]:
    ...
    binary = _remove_small_blobs(binary, min_area=noise_cleanup_min_area)
